class VerticalCards extends HTMLElement {
    constructor() {
        super();
    ...
    setConfig(config) {
		...
		var prop = {  "border": null  , "background_color":null , "font_size":null , "align":null}  ;
		...
		if (!cardConfig.style.align || cardConfig.style.align == null ) cardConfig.style.align = 'center';
...
customElements.define('custom-vertical', VerticalCards);